...
insert into shifts(name,description) values('Shift A','Shift A');
insert into shifts(name,description) values('Shift B','Shift B');
insert into shifts(name,description) values('Shift C','Shift C');
insert into shifts(name,description) values('Shift D','Shift D');
