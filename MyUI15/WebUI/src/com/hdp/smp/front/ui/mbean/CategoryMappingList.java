...
//    public void add(DialogEvent dialogEvent){
//            log.info("......save the cat name to db......");
//            int lastRowIndex = this.data.size();//model.getRowCount();
//            try {
//                CategoryNameValue newobj = createRow();
//                log.info("......the cat is"+newobj);
//                this.save2DB(newobj);
//              // need to add data to ConnectionModel of List also?
//              
//            } catch (Exception e ) {
//               log.error(e);
//            }
//        }
//    
//    protected  CategoryNameValue createRow() {
//          CategoryNameValue row = new CategoryNameValue(this.getName(),this.getValue());
//           return row;
//      }
