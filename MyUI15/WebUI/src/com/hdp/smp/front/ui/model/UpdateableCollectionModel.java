 ...
 */
public class UpdateableCollectionModel<T extends List> extends RowKeyPropertyModel implements ActiveDataModel,
                                                                                             UpdateableModel {
    ...
    public void insertRow(Object rowData) {
        ...
        if (isRowAvailable()) {
            ...
            if (index >= 0) {
                ...
                _fireModelChangeEvent(ActiveDataEntry.ChangeType.INSERT_BEFORE, newKey, currKey);
            }
        }
    }
    ...
    public void deleteRow() {
        ...
        if (index >= 0) {
            ...
            _fireModelChangeEvent(ActiveDataEntry.ChangeType.REMOVE, rowKey, null);
        }
    }
    ...
    public void updateRow(Object rowData) {
        ...
        if (rowIndex >= 0) {
            ...
            Object rowKey = getKeyPath();
            _fireModelChangeEvent(ActiveDataEntry.ChangeType.UPDATE, rowKey, null);
        }
    }
    ...
    public void startActiveData(Collection<Object> rowKeys, int startChangeCount, ActiveDataListener listener) {
    ...
    private Object _append(Object rowData) {
        ...
        try {
            ...
            _fireModelChangeEvent(ActiveDataEntry.ChangeType.INSERT_AFTER, newKey, lastKey);
        } finally {
            setRowKey(oldKey);
        }
    ...
    private void _fireModelChangeEvent(ActiveDataEntry.ChangeType changeType, Object newKey, Object anchorKey) {
        if (_adListener != null) {
